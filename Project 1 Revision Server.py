...
'''counter = 0
if counter%60==0: 
print((time.time() - time_last)/60)'''

'''string_containing_formatters%(data1, data2, etc)
"%d is a digit, %s is a string, %f is a float, %03d is a digit with at least 3 0s"'''

# '%09f'%time.time() #force 9 decimal places ever time